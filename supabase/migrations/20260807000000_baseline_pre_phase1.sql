-- Baseline immediately before Phase 1 hardening.
-- Source: reviewed schema-only supabase/schema.sql; contains no production fixtures or secrets.
-- Keep this migration ordered before 20260807000100_harden_auth_membership_rls.sql.
